...
def main(args):
    ...
    #     param_dicts, lr=args.lr, momentum=args.momentum, weight_decay=args.weight_decay)
...
if __name__ == "__main__":
    ...
    # backbone
    parser.add_argument('--backbone', default='swin_tiny',
    ...
    parser.add_argument("--pretrain_backbone", default='../maskrcnn/pretrained_path/swin_tiny_patch4_window7_224.pth',
                        help="load backbone pretrain weights.")
